...
- [新・Java入門編24: オブジェクト指向について学習しよう（継承・ポリモーフィズム](#新java入門編24-オブジェクト指向について学習しよう継承ポリモーフィズム)
  ...
  - [08: ポリモーフィズムの活用方法](#08-ポリモーフィズムの活用方法)
    - [付録：オブジェクト指向の初学者でもわかるポリモーフィズム](#付録オブジェクト指向の初学者でもわかるポリモーフィズム)
      - [要するに、ポリモーフィズムとは、共通メインルーチンのことです。](#要するにポリモーフィズムとは共通メインルーチンのことです)
      - [なぜポリモーフィズムを使うのか](#なぜポリモーフィズムを使うのか)
    - [付録2：カプセル化とポリモーフィズム：継承との違いと役割](#付録2カプセル化とポリモーフィズム継承との違いと役割)
  - [09: 変数の型](#09-変数の型)
...
### 付録：オブジェクト指向の初学者でもわかるポリモーフィズム

- https://qiita.com/tomonori_hioki/items/d8b1f8a6552c94b3180a
...
### 付録2：カプセル化とポリモーフィズム：継承との違いと役割

- https://www.issoh.co.jp/tech/details/2724
