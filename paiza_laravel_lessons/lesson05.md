...
- [＃01:ユーザー管理機能を理解しよう](#01ユーザー管理機能を理解しよう)
  - [参考になるWebページ](#参考になるwebページ)
- [02:ユーザー管理機能を追加しよう](#02ユーザー管理機能を追加しよう)
  - [新規のアプリケーションディレクトリを追加する](#新規のアプリケーションディレクトリを追加する)
  - [ユーザー管理機能を自動生成](#ユーザー管理機能を自動生成)
- [03:ユーザー管理用のテーブルを用意しよう](#03ユーザー管理用のテーブルを用意しよう)
  - [データベース設定 \> test\_auth/.env](#データベース設定--test_authenv)
  - [マイグレート](#マイグレート)
  - [paiza-cloud用https対応](#paiza-cloud用https対応)
- [04:ログインフォームの動作確認をしよう](#04ログインフォームの動作確認をしよう)
  - [参考になるWebページ](#参考になるwebページ-1)
- [05:ログイン機能を追加しよう](#05ログイン機能を追加しよう)
  - [ユーザー管理用のルートとビューを追加](#ユーザー管理用のルートとビューを追加)
  - [共通テンプレートに、ログイン用のコードを追加する](#共通テンプレートにログイン用のコードを追加する)
  - [csrf\_token()とは？](#csrf_tokenとは)
  - [scriptタグで呼び出しているapp.jsについて](#scriptタグで呼び出しているappjsについて)
- [06:アクセス制御を追加しよう](#06アクセス制御を追加しよう)
  - [登録ユーザーのパスワード](#登録ユーザーのパスワード)
  - [ログインしていない時、実行しないメソッドを指定する](#ログインしていない時実行しないメソッドを指定する)
  - [お店一覧のリンクを制御](#お店一覧のリンクを制御)
- [07:お店情報にユーザー情報を追加しよう](#07お店情報にユーザー情報を追加しよう)
  - [登録ユーザーのパスワード](#登録ユーザーのパスワード-1)
  - [カラムを追加するためのマイグレーションファイルを生成](#カラムを追加するためのマイグレーションファイルを生成)
  - [マイグレーションファイルに、user\_idカラムを追加](#マイグレーションファイルにuser_idカラムを追加)
  - [マイグレート](#マイグレート-1)
  - [usersテーブルにuser\_idを登録](#usersテーブルにuser_idを登録)
  - [Shopモデルに、Userへのリレーションを追加](#shopモデルにuserへのリレーションを追加)
  - [お店一覧に、ユーザー名を追加する](#お店一覧にユーザー名を追加する)
- [08:自分で投稿したお店情報のみ、更新・削除できるようにしよう](#08自分で投稿したお店情報のみ更新削除できるようにしよう)
  - [登録ユーザーのパスワード](#登録ユーザーのパスワード-2)
  - [新規投稿時に、user\_idカラムを保存する](#新規投稿時にuser_idカラムを保存する)
  - [showメソッドで、ログインユーザー情報を取得してビューに渡す](#showメソッドでログインユーザー情報を取得してビューに渡す)
  - [ログインユーザーの記事だったら、リンクを表示](#ログインユーザーの記事だったらリンクを表示)
  - [アクセス制御について](#アクセス制御について)
- [09:セッションとパスワードを理解しよう](#09セッションとパスワードを理解しよう)
  - [登録ユーザーのパスワード](#登録ユーザーのパスワード-3)
  - [セッションとは](#セッションとは)
  - [セッションを確認する手順](#セッションを確認する手順)
  - [パスワードの暗号化について](#パスワードの暗号化について)
